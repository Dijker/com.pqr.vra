...
var _lodash3 = require('lodash.trim');
...
var _ = {
  find: _lodash2.default,
  trim: _lodash4.default
};
...
function deleteOne(categoryAbsolutePath, categoryType, password) {
  ...
  return new _bluebird2.default(function (resolve, reject) {
    _this.vro.categories.getCategoryIdFromAbsolutePath(categoryAbsolutePath, categoryType, password).then(function (categoryId) {
      var options;
...
function getCategoryIdFromAbsolutePath(categoryAbsolutePath, categoryType, password) {
  ...
  return new _bluebird2.default(function (resolve, reject) {
    var category = _path2.default.parse(categoryAbsolutePath);
    ...
    _this.vro.categories.getFromCategoryType(categoryType, true, password).then(function (response) {
...
function getLeafCategoryId(currentCategoryId, categoryPath, password) {
  ...
  return new _bluebird2.default(function (resolve, reject) {
    if (categoryPath.length <= 0) {
      ...
      _this.vro.categories.getOne(currentCategoryId, password).then(function (response) {
